...
<head>
    ...
    <meta name="description" content="Opis stranice o Da Vincijevom kodu">
...
<body>
    <?php
        ...
        echo "<h1>" . $title . "</h1>
            ...
            <p><a href='" . $link . "' target='_blank'>Pročitaj više o Da Vincijevom kodu</a></p>
            <!-- Ime dokumenta: da_vincijev_kod.html -->"
    ?>
</body>
</html>