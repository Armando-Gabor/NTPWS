<?php 
	...
	if (!isset($action)) {
		...
		if ($action == 1) {
			//session_start();
			$_SESSION['news_title_1'] = "<p><a href='index.php?menu=" . $menu . "&action=1'>US growth faster than expected</a></p><br>";
			...
			//session_start();
			$_SESSION['news_title_2'] = "<p><a href='index.php?menu=" . $menu . "&action=2'>Wall Street: Tech firm surge pushes US markets higher</a></p><br>";
			//header("Location: index.php");
			print '
			...
			//session_start();
			$_SESSION['news_title_3'] = "<p><a href='index.php?menu=" . $menu . "&action=3'>Hotel booking sites probed by consumer watchdog</a></p><br>";
			//header("Location: index.php");
			print '
